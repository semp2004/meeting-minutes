...
@section('content')
    <div class="py-12 max-w-7xl mx-auto sm:px-6 lg:px-8 text-gray-800 dark:text-gray-100">
        <div
            ...
            <form method="POST" action="{{ route('agenda-item.update') }}">
                @csrf
                ...
                <div>
                    <textarea name="content" id="content" maxlength="200" placeholder="Agenda punt"
                              class="dark:bg-gray-800 bg-gray-200 dark:text-gray-200 text-gray-800 border-gray-700 border-[1px] focus:outline-none focus:border-gray-400 resize-none px-4 py-2 rounded-lg w-full pb-20 whitespace-pre-wrap whitespace-pre-wrap">{{ $agendaItem->content }}</textarea>
